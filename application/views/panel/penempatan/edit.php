...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><?php echo "Edit " . $this->session->userdata('sub_title'); ?></h1>
    </section>
    ...
    <section class="content">
      <div class="row">
				<div id="leftPanel" class="col-md-4">
					<form method="POST" action="<?php echo site_url('panel/penempatan/proses_edit'); ?>">
            <input type="hidden" name="id_penempatan" value="<?php echo $penempatan->id_penempatan; ?>">
            ...
            <div class="form-group">
              ...
              <select name="nip" class="form-control" required>
                ...
                <option value="<?php echo $pegawai->nip; ?>" <?php echo ($pegawai->nip == $penempatan->nip ? 'selected="selected"' : ''); ?>><?php echo $pegawai->nip; ?></option>
                <?php } ?>
              </select>
            </div>
            <div class="form-group">
              <label>Lokasi</label>
              <input type="text" name="lokasi" class="form-control" value="<?php echo $penempatan->lokasi; ?>" required>
            </div>
            
            <div class="form-group">
              <label>Jam Masuk</label>
              <input type="time" name="jam_masuk" class="form-control" value="<?php echo $penempatan->jam_masuk; ?>" required>
            </div>
            <div class="form-group">
              <label>Jam Pulang</label>
              <input type="time" name="jam_pulang" class="form-control" value="<?php echo $penempatan->jam_pulang; ?>" required>
            </div>

            <div class="form-group">
              <label>Latitude</label>
              <input id="lat" type="text" name="latitude" class="form-control" value="<?php echo $penempatan->latitude; ?>" readonly>
            </div>
            <div class="form-group">
              <label>Longitude</label>
              <input id="long" type="text" name="longitude" class="form-control" value="<?php echo $penempatan->longitude; ?>" readonly>
            </div>
